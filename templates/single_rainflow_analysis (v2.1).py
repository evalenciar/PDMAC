...
press_hist_path = 'Pressure_History.xlsx'
...
# Print results
print('Rainflow results for %i-inch OD x %.3f-inch WT, %i Grade, with data for %.3f year(s), using m = %.3f and min_range = %.3f-psig'%
